import{l as r,h as s,f as l}from"./footer-bHoUKTTi.js";const c=""+new URL("../logo-top.png",import.meta.url).href,d=""+new URL("../logo-middle.png",import.meta.url).href,m=""+new URL("../logo-bottom.png",import.meta.url).href;function p(){const o="/portfolio/src/pages/";let e=document.createElement("section");return e.className="mainSection",e.innerHTML=`
        <h1>
            Portfolio
        </h1>
        <div class="intro"> 
